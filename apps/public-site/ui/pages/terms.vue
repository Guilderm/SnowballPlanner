    ...
    <main class="max-w-4xl mx-auto px-4 py-8">
      ...
      <section class="mb-6">
        ...
        <p class="text-gray-700">
          Welcome to DebtFreePlanner. By accessing or using our service, you agree to be bound by these Terms of Service. If you do not agree with any part of the terms, you must not use our service.
        </p>
      </section>

      <section class="mb-6">
        <h2 class="text-2xl font-semibold mb-2">2. Use of Service</h2>
        <p class="text-gray-700">
      ...
      <section class="mb-6">
        ...
        <p class="text-gray-700">
          All content, features, and functionality on DebtFreePlanner are the exclusive property of DebtFreePlanner and are protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
        </p>
      </section>
      ...
      <section class="mb-6">
        ...
        <p class="text-gray-700">
          We may terminate or suspend your account and access to our service immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms.
        </p>
      </section>

      <section class="mb-6">
        <h2 class="text-2xl font-semibold mb-2">6. Limitation of Liability</h2>
        <p class="text-gray-700">
          In no event shall DebtFreePlanner, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of our service.
        </p>
      </section>

      <section class="mb-6">
        <h2 class="text-2xl font-semibold mb-2">7. Governing Law</h2>
        <p class="text-gray-700">
